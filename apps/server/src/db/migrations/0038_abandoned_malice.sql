...
ALTER TABLE "mail0_connection" ADD COLUMN "imap_security" text;--> statement-breakpoint
...
ALTER TABLE "mail0_connection" ADD COLUMN "smtp_security" text;--> statement-breakpoint
ALTER TABLE "mail0_connection" ADD COLUMN "auth_type" text DEFAULT 'oauth2';--> statement-breakpoint
ALTER TABLE "mail0_connection" ADD COLUMN "encrypted_password" text;--> statement-breakpoint
ALTER TABLE "mail0_connection" ADD COLUMN "last_sync_uid" text;--> statement-breakpoint
...
CREATE INDEX "connection_auth_type_idx" ON "mail0_connection" USING btree ("auth_type");--> statement-breakpoint
